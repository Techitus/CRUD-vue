<template>
  ...
  <form @submit.prevent="addProduct" action="#" method="post" enctype="multipart/form-data">
    <div>
...
export default {
    ...
    methods : {
      async  addProduct(){
            const response = await axios.post("https://660bb1a1ccda4cbc75dd6dc3.mockapi.io/product",this.product)
